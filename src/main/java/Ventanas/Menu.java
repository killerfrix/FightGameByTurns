...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setMaximumSize(new java.awt.Dimension(644, 300));
        jPanel1.setMinimumSize(new java.awt.Dimension(644, 300));
        ...
        jButton4.setText("Dos Jugadores");
        ...
        jButton1.setText("Creador de personaje");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        PVEFrame page1 = new PVEFrame();

        page1.setSize(644, 300);
        page1.setLocation(0, 0);

        jPanel1.removeAll();
        jPanel1.add(page1, BorderLayout.CENTER);
        jPanel1.revalidate();
        jPanel1.repaint();
